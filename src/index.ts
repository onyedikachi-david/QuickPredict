...
if (config.botMode === "webhook") {
  logger.info("Starting Quick-Predict in webhook mode...");
  ...
  logger.info(`Quick-Predict server is running on 0.0.0.0:${config.port}`);
} else {
  logger.info("Starting Quick-Predict in polling mode...");
